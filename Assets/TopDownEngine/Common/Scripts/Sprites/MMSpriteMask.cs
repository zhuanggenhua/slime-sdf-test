...
namespace MoreMountains.Tools
{
	...
	public class MMSpriteMask : MonoBehaviour, MMEventListener<MMSpriteMaskEvent>
	{
		...
		protected virtual void SetupMaskSettingsAutomatically()
		{
			...
			{
				var foundSpriteRenderers = FindObjectsByType<SpriteRenderer>(FindObjectsSortMode.None);
			...
			{
				var foundTilemapRenderers = FindObjectsByType<TilemapRenderer>(FindObjectsSortMode.None);
			...
			{
				var foundParticleSystems = FindObjectsByType<ParticleSystem>(FindObjectsSortMode.None);
