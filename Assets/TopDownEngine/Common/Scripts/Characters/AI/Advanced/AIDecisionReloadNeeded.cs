...
namespace MoreMountains.TopDownEngine
{
	...
	public class AIDecisionReloadNeeded : AIDecision
	{
		...
		public override bool Decide()
		{
			...
			if (_brain.DecisionFrequency == 0)
			{
				return _characterHandleWeapon.CurrentWeapon.WeaponState.CurrentState == Weapon.WeaponStates.WeaponReloadNeeded;	
			}
			else
			{
				return _characterHandleWeapon.CurrentWeapon.WeaponState.CurrentState ==
				       Weapon.WeaponStates.WeaponReloadNeeded
				       || _characterHandleWeapon.CurrentWeapon.WeaponState.PreviousState ==
				       Weapon.WeaponStates.WeaponReloadNeeded;
			}
