...
namespace MoreMountains.TopDownEngine
{
	...
	public class Health : TopDownMonoBehaviour
	{
		...
		protected virtual void GrabAnimator()
		{
			...
			if (TargetAnimator != null)
			{
				if (TargetAnimator.MMHasParameterOfType(_deathAnimatorParameterName, AnimatorControllerParameterType.Trigger))
				{
					_hasDeathParameter = true;
				}
				if (TargetAnimator.MMHasParameterOfType(_healthAnimatorParameterName, AnimatorControllerParameterType.Float))
				{
					_hasHealthParameter = true;
				}
				if (TargetAnimator.MMHasParameterOfType(_healthAsIntAnimatorParameterName, AnimatorControllerParameterType.Int))
				{
